...
def manage_students():
    ...
    return first_student, last_student # should return 'Rob', 'Francine'
...
def combine_foods():
    ...
    meal = ''
    for food in foods:
        meal += food + ' ' # append each food to meal +=  food + ' ' makes more readable
    return meal.strip()  # should return 'pizza burger tacos'
...
def slice_foods():
    foods = ('pizza', 'burgers', 'tacos')
    # Use slicing to get the last two foods
    last_two_foods = foods[-2:]  # should return ('burgers', 'tacos')
    # Return the sliced tuple
    return last_two_foods  # should return ('burgers', 'tacos')
...
def hometown_info():
    ...
    # Return the message
    return home_town_message  # should return "I was born in Butte, Montana - population of 5701"
...
def filter_foods_with_a():
    foods = ('pizza', 'burgers', 'tacos')
    # Use a list comprehension to filter foods with 'a'
    foods_with_an_a = [food for food in foods if 'a' in food]
    # Return the filtered list
    return foods_with_an_a  # should return ['pizza', 'tacos']
